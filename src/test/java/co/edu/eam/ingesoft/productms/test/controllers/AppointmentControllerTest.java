...
public class AppointmentControllerTest {
  ...
  public void save() throws Exception {
    String content = "{\"descripcion\":\"camilo\",\"titulo\":\"prueba\",\"estado\":\"activo\",\"estudianteId\":1,\"psicologoCedula\":\"1\",\"fechaHora\":\"04/05/2015\",\"idCita\":1 }";
    ...
    assertEquals("09/04/05", dateToAssert.getFechaHora());
    assertEquals("1", dateToAssert.getPsicologoCedula());
    assertEquals(new Integer(1), dateToAssert.getEstudianteId());
